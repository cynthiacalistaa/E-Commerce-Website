            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('product.create') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-pen text-primary text-sm opacity-10"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('orders') }}">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-download text-primary text-sm opacity-10"></i>
                        </div>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="fas fa-door-closed text-primary text-sm opacity-10"></i>
                        </div>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="numbers">
                                        <h4 class="font-weight-bolder">{{ $soldProductsCount }}</h4>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <h4 class="font-weight-bolder">{{ $transactionOrders }}</h4>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <h4 class="font-weight-bolder">{{ $shippedOrders }}</h4>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <h4 class="font-weight-bolder">{{ $productCount }}</h4>
                    ...
                    <div class="card">
                        <div class="card-body p-3">
                            <div class="row">
                                <div class="col-8">
                                    <div class="numbers">
                                        <h4 class="font-weight-bolder">{{ $categoryCount }}</h4>
                                        <p class="mb-0">Total Category</p>
                                    </div>
                                </div>
                                <div class="col-4 text-end">
                                    <div
                                        class="icon icon-cart-simple bg-gradient-success shadow-success text-center rounded-circle">
                                        <i class="ni ni-paper-diploma text-lg opacity-10" aria-hidden="true"></i>
                                    </div>
                                </div>
                            </div>
